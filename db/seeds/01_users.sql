...
INSERT INTO quiz_questions(quiz_id, question, answer, correct)
             VALUES (1, 'How many points is a three pointer', 3, TRUE);
INSERT INTO quiz_questions(quiz_id, question, answer, correct)
            VALUES (1, 'How many points is a layup', 2, TRUE);
INSERT INTO quiz_questions(quiz_id, question, answer, correct)
            VALUES (1, 'How many points is a half-court shot', 3, TRUE);
